...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-2">
      <div className="flex flex-wrap justify-center mt-20 mx-6">

        {activeMenu ? (
          <div className="gradient-bg2 dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-white">
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-screen p-8 pt-9 m-3">
            <div className="flex justify-between items-center ">
              <div>
        ...
        <div className="flex m-3 flex-wrap justify-around gap-4 items-center w-full">
          {earningData.map((item) => (
            <div key={item.title} className="bg-white flex-1 h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
